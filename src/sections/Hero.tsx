  ...
  <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
      ...
      <HeroOrbit size={720} rotation={85}>
        <SparkleIcon className="size-3 bg-emerald-300/20 rounded-full"></SparkleIcon>
      </HeroOrbit>
      <HeroOrbit size={520} rotation={-41}>
        <SparkleIcon className="size-2 bg-emerald-300/20 rounded-full"></SparkleIcon>
      </HeroOrbit>
    ...
    <div className="container">
      <div className="flex flex-col items-center">
        <Image src={memojiImage} className="size-[100px]" alt="Renan peeking from behind laptop"/>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            I specialize in transforming designs into functional, high-performing
              web applicaions. Let's discuss your next project.
          </p>
        </div>
